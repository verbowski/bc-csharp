...
namespace java.security
{
    ...
    */
    ...
    public abstract class Policy
    {
         ...
         * @since 1.6
         */
        public static readonly PermissionCollection UNSUPPORTED_EMPTY_COLLECTION =
        ...
        PolicyInfo(Policy policy, bool initialized)
            {
                this.policy = policy;
...
policy.set(pinfo);
                        ...
                        readonly string pc = policy_class;
...
//@Override 
        public override Policy.Parameters getParameters() { return params; }

//@Override 
        public override Provider getProvider() { return p; }
        ...
        : PermissionCollection
{
        ...
        private static readonly long serialVersionUID = -8492269157353014774L;
