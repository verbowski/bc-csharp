   ...
   */
    ...
    public sealed class AccessControlContext
    {
        ...
        public AccessControlContext(ProtectionDomain[] context)
        {
            ...
            {
                List<ProtectionDomain> v = new List<ProtectionDomain>(context.Length);
                ...
                if (!v.isEmpty())
                {
                    this.context = new ProtectionDomain[v.Count];
...
AccessControlContext optimize()
{
    ...
    bool skipStack = (context == null);

    // acc.context could be null if only system code was involved;
    // in that case, ignore the assigned context
    bool skipAssigned = (acc == null || acc.context == null);
...
private static bool containsAllPDs(ProtectionDomain[] thisContext,
