...
namespace java.security.cert
{
   ...
   */
    ...
    public abstract class Certificate : System.Runtime.Serialization.ISerializable
    {

        private static readonly long serialVersionUID = -3585440601605666277L;
         ...
         * @since 1.3
         */
        protected class CertificateRep : ISerializable
        {

            private static readonly long serialVersionUID = -8563758940495660020L;
             ...
             */
            public CertificateRep(string type, byte[] data)
            {
                this.type = type;
                this.data = data;
            }
