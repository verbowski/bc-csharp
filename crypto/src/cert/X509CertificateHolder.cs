 ...
 */
public class X509CertificateHolder: Org.BouncyCastle.Util.Encodable
//    implements Encodable
{
    private X509Certificate x509Certificate;
private X509Extensions extensions;

private static X509Certificate parseBytes(byte[] certEncoding)
{
        try
        {
        return X509Certificate.getInstance(Asn1Object.FromByteArray(certEncoding));
    }
 ...
 */
public X509CertificateHolder(byte[] certEncoding): base(parseBytes(certEncoding));
{
 ...
 */
public X509CertificateHolder(X509Certificate x509Certificate)
{
...
{
    return x509Certificate.Version;
}
...
{
    return X509Name.GetInstance(x509Certificate.IssuerDN);
}
...
{
    return X509Name.GetInstance(x509Certificate.SubjectDN);
}
 ...
 */
public X509Certificate toASN1Structure()
{
 ...
 */
public bool isValidOn(Date date)
{
 ...
 */
public bool isSignatureValid(ContentVerifierProvider verifierProvider)
{
    ...
    ContentVerifier verifier;
        ...
        Stream sOut = verifier.getOutputStream();
