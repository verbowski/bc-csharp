...
//    import java.security.GeneralSecurityException;
    ...
    private static readonly long serialVersionUID = 3192535253797119798L;
     ...
     * @since 1.5
     */
    public CertificateException(String message, Exception cause):base(message, cause)
    {
        ;
    }
     ...
     * @since 1.5
     */
    public CertificateException(Exception cause):base(cause)
    {
        ;
    }
}
