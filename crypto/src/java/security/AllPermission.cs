...
sealed class AllPermissionCollection
    : PermissionCollection , ISerializable
{
    // use serialVersionUID from JDK 1.2.2 for interoperability
    private static readonly long serialVersionUID = -4023755556366636806L;

private static bool all_allowed; // true if any all permissions have been added
...
public override Enumeration<Permission> elements()
{
    ...
    {
            private bool hasMore = all_allowed;
