...
using System.Text;
// http://grepcode.com/file_/repository.grepcode.com/java/root/jdk/openjdk/8u40-b25/java/util/Properties.java/?v=source
namespace java.util
{
    /*
   ...
   */
    ...
    {
        Dictionary<object, object> _internal = new Dictionary<object, object>();
        /**
         * use serialVersionUID from JDK 1.1.X for interoperability
         */
        private static readonly long serialVersionUID = 4112578634029874840L;
         ...
         */
        [MethodImpl(MethodImplOptions.Synchronized)]
        public void load(StreamReader /*Reader*/ reader) // throws IOException
        {
        ...
        protected class LineReader
        {
            ...
            public LineReader(StreamReader /*Reader*/ reader)
            {
                this.reader = reader;
 ...
 */
 //@Deprecated
[Obsolete("The preferred way to save a properties list is store(Stream out,string comments) or storeToXML(Stream os, string comment)")]
public void save(Stream Out, String comments)
{
    try
    {
        store(Out, comments);
...
//        throws IOException
{
    store0((writer is BufferedWriter) ? (BufferedWriter)writer
 ...
 * @since 1.2
 */
public void store(Stream Out, string comments)
//        throws IOException
{
 ...
 */
[MethodImpl(MethodImplOptions.Synchronized)]
public void loadFromXML(Stream In)
 ...
 *          is not a string.
 */
public void list(PrintStream outS)
{
        outS.println("-- listing properties --");
    Dictionary<string, object> h = new Dictionary<string, object>();
    enumerate(h);
 ...
 * compile this file.
 */
public void list(PrintWriter outS)
{
        outS.println("-- listing properties --");
    Dictionary<string, object> h = new Dictionary<string, object>();
    enumerate(h);
                    ...
                    public XmlPropertiesProvider run()
{
    ...
    return new jdk.internal.util.xml.BasicXmlPropertiesProvider();
        ...
        private static readonly XmlPropertiesProvider PROVIDER = loadProvider();

static void load(Properties props, Stream inS)
//            throws IOException, InvalidPropertiesFormatException
        {
            PROVIDER.load(props, inS);
        }

        static void save(Properties props, Stream os, string comment,
                         string encoding)
//            throws IOException
{
