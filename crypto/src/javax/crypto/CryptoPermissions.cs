...
namespace javax.crypto
{
    ...
    */
     ...
     * @since 1.4
     */
    sealed class CryptoPermissions : PermissionCollection, ISerializable
    {

    private static readonly long serialVersionUID = 4946547168093391015L;
...
public void add(Permission permission)
{
    ...
    CryptoPermission cryptoPerm = (CryptoPermissions)permission;
...
private void readObject(ObjectInputStream s)
        ...
        Dictionary<string, PermissionCollection> permTable =
                (Dictionary<string, PermissionCollection>)
...
{
    Dictionary<string,PermissionCollection> permTable =
                new Dictionary<string,PermissionCollection>(perms);
...
public synchronized bool hasMoreElements()
{
