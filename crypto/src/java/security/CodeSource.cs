...
namespace java.security
{
   ...
   */
    ...
    public class CodeSource : ISerializable
    {

        private static readonly long serialVersionUID = 4977541819976013951L;
         ...
         */
        public CodeSource(Uri url, java.security.cert.Certificate certs[])
        {
            this.location = url;
         ...
         * @since 1.5
         */
        public CodeSource(Uri url, CodeSigner[] signers)
        {
            this.location = url;
        ...
        public java.security.cert.Certificate[] getCertificates()
        {
            ...
            else if (signers != null)
            {
                ...
                List<java.security.cert.Certificate> certChains =
                ...
                certs = certChains.toArray(
                            new java.security.cert.Certificate[certChains.Count]);
                return certs.clone();
         ...
         * @since 1.5
         */
        public sealed CodeSigner[] getCodeSigners()
        {
            if (signers != null)
            {
        ...
        public bool implies(CodeSource codesource)
        {
            if (codesource == null)
                return false;
            ...
            java.security.cert.Certificate[] certs)
        {
            ...
            try
            {
                ...
                {
                    return signers.ToArray(new CodeSigner[signers.Count]);
                }
