...
*/
    ...
    public abstract class CipherSpi
    {
         ...
         */
        public abstract void engineSetMode(
            string mode);
         ...
         */
        public abstract void engineSetPadding(
            string padding);
        ...
        {
            throw new NotSupportedException("Underlying cipher does not support key wrapping");
        }
        ...
        {
            throw new NotSupportedException("Underlying cipher does not support key unwrapping");
        }
         ...
         * <p>
         * This concrete method has been added to this previously-defined
         * abstract class. It throws an <code>NotSupportedException</code>
        ...
        //    throws InvalidKeyException
        {
            throw new NotSupportedException("Key size unavailable");
        }
    }
}