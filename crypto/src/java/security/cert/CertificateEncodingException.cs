...
//    package java.security.cert;
    ...
    private static readonly long serialVersionUID = 6219492851589449162L;
     ...
     * @since 1.5
     */
    public CertificateEncodingException(string message, Exception cause): base(message, cause)
        {
        ;
    }
     ...
     * @since 1.5
     */
    public CertificateEncodingException(Exception cause): base(cause)
        {
        ;
    }
}
